...
<a href="../es/complete_schedule_es.html" class="btn btn-outline-primary" role="button">🌐 Lea esto en español</a>
...
The first step to run the complete schedule coverage analyses is to install the PAHOabc package available on GitHub.
