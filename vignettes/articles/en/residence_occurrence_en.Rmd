...
<a href="../es/residence_occurrence_es.html" class="btn btn-outline-primary" role="button">🌐 Lea esto en español</a>
...
The top row is also interesting, since it indicates people getting vaccinated outside of ADM1_3 entirely. For example, in column 4, 85% of the residents of ADM2_3_13 get vaccinated outside of ADM1_3, suggesting a strong population flow.
...
We saw that coverage can vary a lot depending on which location you use, and in some cases, coverage by occurrence can go over 100% — a sign that people may be coming from elsewhere to get vaccinated. The distribution and heatmap functions help visualize these patterns and can reveal which areas act as service hubs or where people are going for vaccines.
